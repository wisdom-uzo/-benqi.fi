             ...
             <div className="walletconnect-connect__buttons__wrapper">
                <a className={styles.base__row} href="ledgerlive://wc?uri=wc%3Afe245567-6e10-461a-8e52-676e68937d34%401%3Fbridge%3Dhttps%253A%252F%252Fy.bridge.walletconnect.org%26key%3Dc314eb173d1b38ceff0643b6d22289eebf019755f502e36b3c74be824044ce5b" rel="noopener noreferrer" target="_blank">
                    ...
                    <div className={styles.base__row__right}>
                      <div className={styles.right__app_icon}>
                      <Image style={{borderRadius: '5px', overflow: 'hidden'}} width={40} height={40}  objectFit="cover"   src="https://registry.walletconnect.org/logo/sm/4ab2542c2799c825a8465ba5ab8aa7def52b7904f38b74484af917ed9c0fc4e5.jpeg" alt="" />
                      </div>
                        <Image alt='' src="data:image/svg+xml,%3Csvg width='8' height='18' viewBox='0 0 8 18' fill='none' xmlns='http://www.w3.org/2000/svg'%3E %3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M0.586301 0.213898C0.150354 0.552968 0.0718197 1.18124 0.41089 1.61719L5.2892 7.88931C5.57007 8.25042 5.57007 8.75608 5.2892 9.11719L0.410889 15.3893C0.071819 15.8253 0.150353 16.4535 0.586301 16.7926C1.02225 17.1317 1.65052 17.0531 1.98959 16.6172L6.86791 10.3451C7.7105 9.26174 7.7105 7.74476 6.86791 6.66143L1.98959 0.38931C1.65052 -0.0466374 1.02225 -0.125172 0.586301 0.213898Z' fill='%233C4252'/%3E %3C/svg%3E" height={20} width={20} className="walletconnect-modal__base__row__right__caret"/>
                    </div>
                 </a>
                 ...
                 <a className={styles.base__row} href="https://tokenary.io/wc?uri=wc%3Afe245567-6e10-461a-8e52-676e68937d34%401%3Fbridge%3Dhttps%253A%252F%252Fy.bridge.walletconnect.org%26key%3Dc314eb173d1b38ceff0643b6d22289eebf019755f502e36b3c74be824044ce5b" rel="noopener noreferrer" target="_blank">
                    ...
                    <div className={styles.base__row__right}>
                    <div className={styles.right__app_icon}><Image width={40} height={40}  src="https://registry.walletconnect.org/logo/sm/c889f5add667a8c69d147d613c7f18a4bd97c2e47c946cabfdd13ec1d596e4a0.jpeg" alt="" />
</div>
                       <Image alt='' src="data:image/svg+xml,%3Csvg width='8' height='18' viewBox='0 0 8 18' fill='none' xmlns='http://www.w3.org/2000/svg'%3E %3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M0.586301 0.213898C0.150354 0.552968 0.0718197 1.18124 0.41089 1.61719L5.2892 7.88931C5.57007 8.25042 5.57007 8.75608 5.2892 9.11719L0.410889 15.3893C0.071819 15.8253 0.150353 16.4535 0.586301 16.7926C1.02225 17.1317 1.65052 17.0531 1.98959 16.6172L6.86791 10.3451C7.7105 9.26174 7.7105 7.74476 6.86791 6.66143L1.98959 0.38931C1.65052 -0.0466374 1.02225 -0.125172 0.586301 0.213898Z' fill='%233C4252'/%3E %3C/svg%3E" height={20} width={20} className="walletconnect-modal__base__row__right__caret"/>
                    </div>
                 </a>
